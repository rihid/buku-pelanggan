            ...
            <div className="bg-white p-6 rounded w-1/2">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button type="button" className="text-md font-normal leading-6 text-gray-900 px-6 bg-transparent hover:bg-blue" onClick={() => {return props.setShow(false)}} >Close</button>
